...
def distance_between_catpoints(srcShp, facilitiesShp, networkShp, speedLimitCol,
    ...
    POINTS = merge_shp([srcShp, facilitiesShp],
    ...
    from gasp.cpu.grs.netanlst  import netpath
    ...
    pntShp  = grass_converter(POINTS, "points_net")
    ...
    return grass_converter(result, outputShp, geom_type="line", lyrN=3)
