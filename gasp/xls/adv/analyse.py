...
def frequencies_by_place(xls, entities_sheet, entities_id, entities_place,
    ...
    from gasp.xls.summarize import list_unique_values_column
    from gasp.xls.summarize import count_values_column
    from gasp.xls.summarize import count_values_column_if_entity_exists
    from gasp.xls.summarize import count_values_column_by_entity_property
