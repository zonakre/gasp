...
def files_to_map(main_mxd, lyr_to_change, dataFrame, lyr_folder,
    ...
    * layout_elm_table = file with the indication of what text should appear
    ...
    from gasp.cpu.arcg.maps.dframe import lst_dataframe
    ...
    filesByLyr = xls_to_dict(lyr_to_change)
    
    # List graphic elements to be changed
    files_and_element = xls_to_dict(layout_elm_table)
...
def maps_by_extent(extentSource, baseMxd, MAIN_DATAFRAME, EXTENT_LYR_NAME,
    ...
    * CONTEXT_DATAFRAME - dict with metainfo about other dataframe with
    ...
    from gasp.cpu.arcg.maps.lyrs   import lst_layers
    from gasp.cpu.arcg.maps.lyrs   import get_layers_by_dataframe
    from gasp.cpu.arcg.maps.dframe import lst_dataframe
    from gasp.cpu.arcg.maps.graph  import get_elem_by_name
    from gasp.cpu.arcg.maps.wmap   import write_map
    from gasp.cpu.arcg.maps.wmap   import mxd_saveas
    ...
    # List graphic elements to be changed
    files_and_element = xls_to_dict(MAP_GRAPH_ELEM)
